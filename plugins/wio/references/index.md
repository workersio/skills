...
WIO exposes three user-facing testing workflows:

| Workflow | Primary References |
| --- | --- |
| [scan](../skills/scan/SKILL.md) | Behavior To Test Map, Risk-Based Testing, User Behavior Testing, Test Level Selection, and the relevant topic reference for the chosen strategy. |
| [test](../skills/test/SKILL.md) | The reference that explains the selected strategy: testability, level selection, user behavior, doubles, oracles, data, or feedback loops. |
| [doctor](../skills/doctor/SKILL.md) | Test Suite Health Diagnostics, then targeted references for level, oracle, doubles, data, flake, and feedback-loop findings. |
