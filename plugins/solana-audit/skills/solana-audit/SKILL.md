...
Produce the final audit report using the template in [references/report-template.md](references/report-template.md). **Every finding MUST include its taxonomy ID** from [references/vulnerability-taxonomy.md](references/vulnerability-taxonomy.md) and its **confidence score**.
