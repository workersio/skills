...
see:
`skills/audit-context-building/resources/FUNCTION_MICRO_ANALYSIS_EXAMPLE.md`

For the full completeness checklist to verify your output against, see:
`skills/audit-context-building/resources/COMPLETENESS_CHECKLIST.md`

For detailed output formatting requirements, see:
`skills/audit-context-building/resources/OUTPUT_REQUIREMENTS.md`
